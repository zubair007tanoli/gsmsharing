...
namespace discussionspot.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUsers>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Table naming
            builder.Entity<Community>().ToTable("Community");
            ...
            // Configure SeoMetadata relationships
            builder.Entity<SeoMetadata>()
                .HasOne<Post>()
                .WithOne()
                .HasForeignKey<SeoMetadata>(s => new { s.EntityId })
                .HasPrincipalKey<Post>(p => p.PostId)
                .IsRequired(false)
            ...
            builder.Entity<SeoMetadata>()
                ...
                .WithOne()
                .HasForeignKey<SeoMetadata>(s => new { s.EntityId })
                .HasPrincipalKey<Community>(c => c.CommunityId)
                .IsRequired(false)
                .OnDelete(DeleteBehavior.NoAction);
